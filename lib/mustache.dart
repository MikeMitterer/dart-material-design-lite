...
import 'src/mustache/template.dart' as t;

/// Use new Template(source) instead.
@deprecated
Template parse(String source, {bool lenient : false}) => new Template(source, lenient: lenient);
...
abstract class Template {
    ...
    factory Template(String source, { bool lenient, bool htmlEscapeValues, String name,
