...
##More information
For working examples of the **shadow** effect, see the MDL [shadow demo page](https://github.com/MikeMitterer/dart-material-design-lite/tree/mdl/example/shadow). Also see the MDL [card demo page](www.github.com/google/material-design-lite/src/card/demo.html).
