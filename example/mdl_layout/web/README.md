...
##More information
For working examples of the **layout** component, see the MDL [layout demo page](https://github.com/MikeMitterer/dart-material-design-lite/tree/mdl/example/layout).
